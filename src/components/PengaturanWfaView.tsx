  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-[#004080] to-[#0060b5] rounded-2xl p-6 text-white shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-blue-100/90 mt-1 max-w-xl">
            Kelola parameter kebijakan kerja, jam presensi pagi &amp; siang, standar centang to-do list, passing grade KPI, dan integrasi Zoom.
          </p>
        </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        {/* SECTION 6: Konfigurasi Zoom Standup Perusahaan */}
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
          <div className="flex items-center gap-2.5 border-b border-slate-100 pb-3">
            <div className="w-8 h-8 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center font-bold">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900">
                6. Integrasi Zoom API &amp; Standup Perusahaan
              </h2>
              <p className="text-xs text-slate-500">
                Link default dan konfigurasi meeting sinkronisasi harian tim.
              </p>
            </div>
          </div>

...
export const BerandaSayaView: React.FC<BerandaSayaViewProps> = ({ onNavigate }) => {
  ...
  const activeMeetings = getActiveZoomMeetingsForEmployee(zoomMeetings, entry.date);
  ...
  const handleJoinMeetingClick = (meeting: ZoomMeetingInfo) => {
    if (!entry.absenPagi) {
      ...
      showToast('Wajib Absen Pagi terlebih dahulu sebelum bergabung ke Zoom!', 'warning');
      return;
    }
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="font-extrabold text-sm tracking-tight text-white flex items-center gap-1.5">
                  ...
                  <span>Zoom Koordinasi Tim Sedang Berlangsung</span>
                </span>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-slate-600 mt-0.5">
                Zoom koordinasi &rarr; Absen pagi + GPS &rarr; Isi to-do list
              </div>
            </div>
          </div>

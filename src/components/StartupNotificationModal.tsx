...
export const StartupNotificationModal: React.FC<StartupNotificationModalProps> = ({ onNavigate }) => {
  ...
  const storageKeyPagi = `wfa_startup_notif_seen_pagi_${currentUser.id}_${selectedDate}`;
  const storageKeySiang = `wfa_startup_notif_seen_siang_${currentUser.id}_${selectedDate}`;
